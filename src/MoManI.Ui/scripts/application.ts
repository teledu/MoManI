...
var application = angular.module('application', ['ngRoute', 'ngResource', 'ui.bootstrap', 'mgcrea.ngStrap.navbar', 'checklist-model', 'ngHandsontable', 'nvd3', 'angular-confirm', 'treeGrid', 'angularSpinner', 'color.picker']);
